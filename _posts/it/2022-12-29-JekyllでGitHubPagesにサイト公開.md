...
>...省略...
>```
>いろいろ調べたが、[Ruby (Versioning) Hell with Jekyll & GitHub Pages](https://ritviknag.com/tech-tips/ruby-versioning-hell-with-jekyll-&-github-pages/)からヒントをもらい、次のように対応した
>```sh
